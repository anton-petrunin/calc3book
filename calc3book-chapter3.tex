...
\resume{enumerate}[{[\bfseries 1.]}]
 ...
 \end{multicols}
 \item Let $M$ be a constant. Show that $\int_c^d \int_a^b M\,dx\,dy = M(d-c)(b-a)$.
\end{enumerate}
\newpage
%Begin Section 3.2
...
\begin{exmp}\label{exmp:uspherecenter}
 ...
 if the density function at $(x,y,z)$ is $\delta(x,y,z) = 1$.\vspace{0.5mm}
 \piccaption[]{}\parpic[r]{\begin{tikzpicture}
  \usetikzlibrary{arrows}
 ...
 \par\noindent \emph{Solution:} The solid $S$ is just the upper hemisphere inside the sphere of radius $a$ centered at

...
\resume{enumerate}[{[\bfseries 1.]}]
 ...
 \item Consider the vector equation $\thickspace\Crossprod{\textbf{a}}{\textbf{x}} = \textbf{b}\thickspace$
  ...
  \begin{enumerate}[(a)]
   \item If the equation has a solution then $\Dotprod{\textbf{a}}{\textbf{b}} = 0$.
   \item In this case $\textbf{x} = \dfrac{\Crossprod{\textbf{b}}{\textbf{a}}}{\norm{\textbf{a}}^2} + k \textbf{a}\thickspace$
...
\resume{enumerate}[{[\bfseries 1.]}]
 \item The B\'{e}zier curve $\ssub{\textbf{b}}{0}^{\scriptscriptstyle 3}(t)$ for four noncollinear points
  ...
  \end{enumerate}
 \item Let $\textbf{r}(t)$ be the position vector for a particle moving in $\Real{3}$. 
Show that
  \begin{displaymath}

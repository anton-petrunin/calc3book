...
Show that its acceleration $\textbf{a}(t)$ points in the opposite direction as
 ...
 Write an expression for the trajectory of the front wheel $\textbf{b}(t)$. 
 Use it to show that the speed of the back wheel can not exceed the speed of the front wheel.
...
The arc length parametrization is particularly useful to make such constructions.

For example, 
assume a smooth curve $\textbf{g}$ with the arc length parametrization.
...
If $\kappa(s)=0$ then osculating circle degenerates to the tangent line.
...
Exercises 7--9 guide you through similar calculations.

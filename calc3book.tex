...
pdfauthor={Michael Corral and Anton Petrunin},pdftitle={Corral's Vector Calculus},
...
\usepackage{breakurl}
\usepackage[integrals]{wasysym}%added by Petrunin
\usepackage{lpic,wrapfig}%added by Petrunin
...
\providecommand{\Abs}[1]{\left|\mspace{1mu}#1\mspace{1mu}\right|}
...
%\centerline{\includegraphics[height=0.3\textheight]{sincplain.eps}}\vspace{-25mm}
\centerline{\input{sincplaincover}}
\vspace{10mm}
...
\medskip
\centerline{\Large{and Anton Petrunin}}
...
\include{vectors}
\include{curves}
\include{mult-functions}
\include{mult-integrals}
\include{surf-integrals}
\newpage
%Put the bibliography here
\bibliography{calc3book}
\nocite{*}
%Put appendices here
\include{calc3book-appendixa}
%\include{calc3book-appendixb}
%\include{calc3book-appendixc}
\newpage

...
The idea behind the above definition is that the values of $f(x,y)$ can get arbitrarily close to $L$ 
(that is, within $\epsilon$ of $L$) 
if we pick $(x,y)$ sufficiently close to $(a,b)$ 
(that is, inside a circle centered at
...
$(a,b)$ 
(for example, is not some indeterminate form like $0/0$) then you can just substitute $(x,y) = (a,b)$ into the formula
...
\begin{exmp}
 ...
 \begin{displaymath}
  ...
  \end{cases}
 \end{displaymath}
Then $f(x,y)$ is well-defined for all $(x,y)$ in $\Real{2}$
(that is, there are no indeterminate forms for any $(x,y)$), 
and we see that
 \begin{displaymath}
...
\probs{A}
\par\noindent For Exercises \ref{ex:range-domain:start}--\ref{ex:range-domain:end}, state the domain and range of the given function.
\begin{enumerate}[\bfseries 1.]
 \begin{multicols}{2}
  \item\label{ex:range-domain:start} $f(x,y) = x^2 + y^2 - 1; \phantom{\dfrac{1}{x^2}}$
 ...
 \begin{multicols}{2}
  ...
  \item\label{ex:range-domain:end} $f(x,y,z) = \sqrt{(x-1)(yz-1)}$.
 \end{multicols}
\suspend{enumerate}
\par\noindent For Exercises \ref{ex:lim:start}--\ref{ex:lim:end}, evaluate the given limit.
\resume{enumerate}[{[\bfseries 1.]}]
 \begin{multicols}{2}
  \item\label{ex:lim:start} $\displaystyle\lim_{(x,y) \to (0,0)}~ \cos (xy)$;
 ...
 \begin{multicols}{2}
  ...
  \item\label{ex:lim:end} $\displaystyle\lim_{(x,y) \to (0,0)}~ \cos \left( \frac{1}{xy} \right)$.
 \end{multicols}
\suspend{enumerate}
\probs{B}
\resume{enumerate}[{[\bfseries 1.]}]
...
\begin{enumerate}[\bfseries 1.]
 \begin{multicols}{2}
  \item\label{ex:par-der:start} $f(x,y) = x^2 + y^2$;
  \item $f(x,y) = \cos(x+y)$;
 \end{multicols}
 \begin{multicols}{2}
 ...
 \begin{multicols}{2}
  \item $f(x,y) = \sin(xy)$;
  \item\label{ex:par-der:end} $f(x,y) = \tan(x+y)$.
 \end{multicols}
\suspend{enumerate}
\par\noindent For Exercises \ref{ex:2par-der:start}--\ref{ex:2par-der:end}, find $\frac{\partial^2 f}{\partial x^2}$, $\frac{\partial^2 f}{\partial y^2}$
and $\frac{\partial^2 f}{\partial y \, \partial x}$ (use Exercises 1--8, 14, 15).
\resume{enumerate}[{[\bfseries 1.]}]
 \begin{multicols}{2}
  \item\label{ex:2par-der:start} $f(x,y) = x^2 + y^2$;
  \item $f(x,y) = \cos(x+y)$;
 \end{multicols}
 \begin{multicols}{2}
  \item $f(x,y) = \sqrt{x^2 + y + 4}$;
 ...
 \begin{multicols}{2}
  \item $f(x,y) = \ln (xy)$;
  \item\label{ex:2par-der:end} $f(x,y) = \sin(xy)$.
 \end{multicols}
\suspend{enumerate}
\probs{B}
\resume{enumerate}[{[\bfseries 1.]}]
...
\piccaption[]{}\parpic[r]{\begin{tikzpicture}
   ...
   \node at (0.8,2) {\small $\ssub{\mathbf{v}}{x}=(1,0,\frac{\partial f}{\partial x}(a,b))$};
...
\statedefn{defn:dirderiv}{\index{directional derivative}\index{derivative!directional}
 {Let $f(x,y)$ be a real-valued function with domain $D$ in $\Real{2}$, and let $(a,b)$ be a point in $D$. Let
  $\mathbf{v}$ be a vector in $\Real{2}$. Then the
  \textbf{directional derivative of $\bm{f}$ at $\bm{(a,b)}$ in the direction of v}, denoted by
  $\ssub{D}{\mathbf{v}}f(a,b)$, is defined as
  \begin{equation}\label{eqn:dirderiv}
   \ssub{D}{\mathbf{v}}f(a,b) = \lim_{h \to 0} \dfrac{f((a,b) + h\mathbf{v}) - f(a,b)}{h}.
  \end{equation}}
}
...
directional derivative:\index{$\ssub{D}{\mathbf{v}}f$}
...
\statethm{thm:dirderiv}{
 ...
 a point in $D$. Then
  ...
  \end{equation}}
  for any vector $\mathbf{v} = \vectwo{v}$ in $\Real{2}$
}
\begin{proofbar}
\begin{proof}[Proof:]
...
\statethm{thm:multichain}{
 {Let $f(x,y)$ be a real-valued function with domain $D$ in $\Real{2}$ such that the partial derivatives
 $\tfrac{\partial f}{\partial x}$ and $\tfrac{\partial f}{\partial y}$ exist and are continuous in $D$
 and $\mathbf{h}(t)=(\ssub{h}{1}(t),\ssub{h}{2}(t))$ be a smooth function with values in $D$. 
 Then
  \begin{equation}\label{eqn:multi-chain}
  \begin{aligned}
  f(\mathbf{h}(t))'&=\ssub{D}{\mathbf{h}'(t)}f(\mathbf{h}(t))
  \\
   &= \ssub{h'}{1}(t)\frac{\partial f}{\partial x}(\ssub{h}{1}(t),\ssub{h}{2}(t)) +
    \ssub{h'}{2}(t)\frac{\partial f}{\partial y}(\ssub{h}{1}(t),\ssub{h}{2}(t)).
  \end{aligned}
  \end{equation}}
}

Note that $\ssub{D}{\mathbf{v}}f(a,b) = \Dotprod{\mathbf{v}}{\biggl(\frac{\partial f}{\partial x}(a,b),
\frac{\partial f}{\partial y}(a,b)\biggr)}$. 
...
{In the assumptions of the theorems \ref{thm:dirderiv} and \ref{thm:multichain} we have
\begin{enumerate}[(a)]
\item $\ssub{D}{\mathbf{v}}f = \Dotprod{\mathbf{v}}{\nabla f}$; 
\item $f(\mathbf{h}(t))'= \Dotprod{\mathbf{h}'(t)}{\nabla f}$
\end{enumerate}
}
}
\index{Chain Rule}
...
\begin{exmp}
 ...
 $\mathbf{v} = \biggl( \frac{1}{\sqrt{2}},\frac{1}{\sqrt{2}} \biggr)$.\smallskip
 \par\noindent\emph{Solution:} We see that $\nabla f = (y^2 + 3x^2 y, 2xy + x^3)$, so\index{$\nabla$}
 \begin{displaymath}
  \ssub{D}{\mathbf{v}}f(1,2) ~=~ \Dotprod{\mathbf{v}}{\nabla f(1,2)}
...
the rate of change of $f$ in the direction of $\mathbf{v}$ is $0$;
that is, $\ssub{D}{\mathbf{v}}f = 0$. 
But we know that
...
\begin{enumerate}[\bfseries 1.]
 ...
 $\mathbf{v} = \biggl( \frac{1}{\sqrt{2}},\frac{1}{\sqrt{2}} \biggr)$.
 \resume{enumerate}[{[\bfseries 1.]}]
 \begin{multicols}{2}
...
\resume{enumerate}[{[\bfseries 1.]}]
 ...
 \end{multicols}
 \begin{multicols}{2}
  \item $\ssub{D}{-\mathbf{v}}f = -\ssub{D}{\mathbf{v}}f$;
  \item $\ssub{D}{\mathbf{v}}(cf) = c\,\ssub{D}{\mathbf{v}}f$;
 \end{multicols}
 \begin{multicols}{2}
  \item $\ssub{D}{\mathbf{v}}(f+g) = \ssub{D}{\mathbf{v}}f ~+~ \ssub{D}{\mathbf{v}}g$;
  \item $\ssub{D}{\mathbf{v}}(fg) = f\,\ssub{D}{\mathbf{v}}g ~+~ g\,\ssub{D}{\mathbf{v}}f$.
 \end{multicols}
...
\textbf{local maximum} at $(x_0,y_0)$ if $f(x,y) \le f(x_0,y_0)$ for all $(x,y)$ inside some disk of positive radius centered at $(x_0,y_0)$;
that is, there is some sufficiently small $r > 0$ such that $f(x,y) \le f(x_0,y_0)$ for all $(x,y)$ for
...
while along the path $y=-x$ we have $f(x,y)=-x^2$, which has a local maximum at $(0,0)$. So $(0,0)$ is an example of a \emph{saddle point};
that is, it is a local maximum in one direction and a local minimum in another direction. 
The graph
...
\statecomment{If $D_{\mathbf{v}}f(x_0,y_0)=0$ and $D_{\mathbf{v}}^2f(x_0,y_0)>0$ for any vector $\mathbf{v}\ne\mathbf{0}$ then the the smooth function $f(x,y)$ of two variables, has a local minimum at $(x_0,y_0)$.}
...
minimum of a \emph{smooth function}\index{smooth function} (that is, a function whose partial derivatives of all orders
exist and are continuous).
The theorem will not be proved here.\footnote{See \cite[\S\,7.6]{tm}.}\index{Second Derivative Test}

\statethm{thm:extsuff}{
{Let $f(x,y)$ be a smooth real-valued function, with a critical point at $(x_0,y_0)$ (that is,
...
\begin{exmp}
 ...
 \end{gather*}
 Notice that solving $\nabla f = \mathbf{0}$ would involve solving two third-degree polynomial equations in $x$ and
...
\statethm{thm:lagrange}{
 ...
 that $\nabla g(x,y) \ne \mathbf{0}$ for all $(x,y)$ that satisfy the equation $g(x,y) = c$. 
 Then to solve the
...
The following condition guarantees existence of maximum and minimum; a proof is given in \cite{tm}.

\smallskip

\statecomment{If the constraint equation $g(x,y)=c$  as above describes a bounded set in $\Real{2}$, then the constrained maximum and minimum of $f(x,y)$ will occur at some points.}
...
\statecomment{If the set described by system $g(x,y)=c$,  $f(x,y)\le d$ is not empty and bounded for some $d$ then the constrained minimum of $f(x,y)$ will occur at some points.}
...
then the set described by $f(x,y)\le d$
is bounded for any $d$.
...
\statecomment{If the set described by system $g(x,y)=c$,  $f(x,y)\ge d$ is not empty and bounded for some $d$ then the constrained maximum  of $f(x,y)$ will occur at some points.}
...
Non of these points is maximum, nor minimum; 
in fact, $f$ can positive and negative values with arbitrary large absolute value.

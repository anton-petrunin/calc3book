...
(see Figure \ref{fig:lineintdef} below).
...
\begin{align*}
 ...
 \frac{\partial z}{\partial u}(u,v) \textbf{k} ~,~~\text{and}\smallskip\\
...
\begin{exmp}
 Evaluate $\iint\limits_{\Sigma} \Dotprod{\textbf{f}}{d\bm{\sigma}}$, where $\textbf{f}(x,y,z) = x\textbf{i} +
  y\textbf{j} + z\textbf{k}$ and $\Sigma$ is the unit sphere $x^2 + y^2 + z^2 = 1$.\smallskip
...
\picskip{0} 
 ...
 \end{align*}
 So we see that 
 \[\olineintvec{C}{f}{r}=\iint_{\Sigma} \Dotprod{(\text{curl}~{\textbf{f}}\,)}{\textbf{n}}
...
\begin{align*}
 \Crossprod{\nabla}{\textbf{f}} ~&=~
 \begin{vmatrix}
  \textbf{i} & \textbf{j} & \textbf{k} \smallskip\\ \dfrac{\partial}{\partial x} & \dfrac{\partial}{\partial y} &
